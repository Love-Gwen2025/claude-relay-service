...
const CodexAppValidator = require('./clients/codexAppValidator')
const OpencodeValidator = require('./clients/opencodeValidator')
...
const VALIDATOR_MAP = {
  ...
  [CLIENT_IDS.CODEX_APP]: CodexAppValidator,
  [CLIENT_IDS.OPENCODE]: OpencodeValidator,
